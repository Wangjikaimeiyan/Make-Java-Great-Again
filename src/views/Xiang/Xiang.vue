...
import { queryAllApi, queryApiFilter, queryinfoId, updateDish, addDish, deleteDish, aichat } from '@/api/Xiang'
...
const messageList = ref([
    { role: 'assistant', content: '你好！我是湘菜AI助手，有什麼可以幫你？' }
])
                ...
                <div class="demo-input-with-icon">
                    <div class="input-group">
                        <div class="input-container">
                            ...
                            <el-input v-model="input1" class="responsive-input" placeholder="请输入菜品名字"
                                :prefix-icon="Search" />
                            <span class="label">
                                价格筛选:
                            </span>
                            <el-input v-model="input2" class="responsive-input" placeholder="筛选最高价"
                                :prefix-icon="Search" />
                            <!-- 查询，重置按钮 -->
                    ...
                    <el-card v-for="item in dishList" :key="item.id">
                        ...
                        <div class="card-body-wrapper">
                            ...
                            <div class="right-action">
                                ...
                                <!-- 删除 按钮 -->
                                <el-button type="danger" @click="deleteThisDish(item.id)" icon="Delete"
            ...
            <div class="right-container">
                ...
                <div class="ai-chat-box">
                    ...
                    <div class="chat-footer">
                        <el-input v-model="userInput" type="textarea" :rows="2" placeholder="請輸入消息..."
